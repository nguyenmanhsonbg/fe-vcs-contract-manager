...
export interface ContractTemplateVersionDto { id: string; code: string; name: string; contractType: ContractType; version: number; docxResourceKey: string; status: string; }
