...
export interface LineItem { id: string; no: number; name: string; code: string; qty: string; unitPrice: string; total: string; confidence: number; region?: { page: number; x: number; y: number; w: number; h: number } | null; }
