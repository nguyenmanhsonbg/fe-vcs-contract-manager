...
export function DocumentListPage({
  ...
  const [uploader] = useState<string>("all");
  const [assignee] = useState<string>("all");
  const [lowConfOnly] = useState(false);
        ...
        <div className="flex items-center justify-between h-[44px]">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <button
              ...
              className="size-[38px] rounded-[6px] border border-slate-200 bg-white text-slate-500 hover:bg-slate-50 flex items-center justify-center shadow-2xs transition-colors shrink-0 cursor-pointer"
            >
              ...
              {documents.map((d) => (
                ...
                >
                  <td className="py-2.5 px-3">
                    <p className="font-normal text-[#393740] truncate max-w-[280px] text-[12px] leading-[17px]" title={d.fileName}>
                      {d.fileName}
                    </p>
                  </td>
                  <td className="py-2.5 px-3 text-[#393740] font-normal whitespace-nowrap text-[12px] leading-[17px]">
                  ...
                  <td className="py-2.5 px-3 text-right whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                    <button
                      ...
                      className="p-1 text-slate-500 hover:text-[#3f81ea] hover:bg-slate-100 rounded transition-colors cursor-pointer"
