...
import { DocumentViewerToolbar, getNextZoom } from "./components/DocumentViewerToolbar";
    ...
    <div className="h-full w-full bg-[#f8f7fa] p-4 flex flex-col overflow-hidden font-sans">
      ...
      <div className="bg-white rounded-[6px] border border-slate-200 p-5 shadow-[0px_4px_18px_0px_rgba(75,70,92,0.10)] flex flex-col flex-1 overflow-hidden space-y-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            onClick={onBack}
            className="p-1 hover:bg-slate-100 rounded-[6px] text-[#2F2B3D] transition-colors cursor-pointer"
            title="Quay lại"
          >
        ...
        {/* Fit Desktop Canvas Display Area */}
        <div
