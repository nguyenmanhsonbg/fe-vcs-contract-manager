...
} from "../modals/AcceptanceReportSideModal";
import { UploadModal } from "../modals/UploadModal";

// Data Model matching Figma Node 28538:22065
...
// Activity Timeline Mock Data matching Figma Node 28538:22317
...
export function AcceptanceListPage({}: AcceptanceListPageProps = {}) {
  ...
  return (
    <div className="space-y-6 bg-[#f8f7fa] p-6">
      {/* Page Header matching Figma Node 28538:22065 & 28538:22072 */}
      <PageHeader
      ...
      {/* Main Table Card (Figma Node 28538:22065) */}
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-12 items-end">
          ...
          <div className="lg:col-span-1">
            <button
              ...
              className="flex h-[38px] w-full items-center justify-center gap-1.5 rounded-[6px] border border-[#dbdade] bg-white px-3 text-[13px] font-medium text-slate-700 hover:bg-slate-50 transition-colors shadow-2xs"
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-center">
                      <button
                        ...
                        className="inline-flex size-7 items-center justify-center rounded text-[#3f81ea] hover:bg-[#3f81ea]/10 transition-colors"
      ...
      {/* Side Drawer Modal: Chi tiết Biên bản nghiệm thu (Figma Node 28544:25367) */}
      <AcceptanceReportSideModal
        open={sideModalOpen}
