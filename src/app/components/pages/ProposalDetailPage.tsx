...
export function ProposalDetailPage({ proposalId, onBack }: ProposalDetailPageProps) {
  ...
  return (
    <div className="w-full space-y-5 bg-[#f8f7fa] p-6 text-[#2f2b3d]">
      {/* Top Header matching Figma node 26008:557287 */}
      ...
      {/* Main Content Area */}
      {isFullscreen ? (
        /* Fullscreen Preview Mode (Figma Screen 3) */
...
// Multi-page Proposal Document Preview with interactive toolbar and 12-page display
function ProposalDocumentPreview({
  ...
  // Content for each page of the 12-page proposal document
  const proposalPages = [
    {
      pageNumber: 1,
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2 text-[8.5px] text-slate-700">
          ...
          <p className="pt-1">Nội dung nghiệm thu: Kiểm tra tem niêm phong chính hãng, CO/CQ, số Serial và in thử 500 trang mẫu kiểm tra tốc độ.</p>
        </div>
      ),
    },
    {
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-y border-slate-100 py-2 text-xs text-[#5d586c]">
        ...
        <div className="flex items-center gap-2">
          {/* Complete 1 to totalPages Select Dropdown */}
          <div className="relative inline-flex items-center">
            <select
              value={page}
      ...
      {/* Document View Canvas Area — Continuous Scroll with all 12 pages */}
      <div
        ref={containerRef}
          ...
          >
            {proposalPages.map((p) => (
              ...
              >
                ...
                {/* Header for Page 1 vs other pages */}
                {p.pageNumber === 1 ? (
                  <div className="flex justify-between border-b border-slate-300 pb-2">
                    <div className="text-center font-sans">
                      ...
                      <p className="mt-1 text-[8.5px]">Số: {proposalData.generalInfo.proposalNumber || "TT-2025-028"}/TTr-HCTH</p>
                ...
                <div className="mt-6 pt-2 border-t border-slate-100 flex justify-between items-center text-[7.5px] text-slate-400 font-sans">
                  ...
                  <span>Trang {p.pageNumber} / {totalPages}</span>
                </div>
              </div>
            ))}
          </div>
