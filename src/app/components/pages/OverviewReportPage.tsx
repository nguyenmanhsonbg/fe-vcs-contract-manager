...
import { TaskDetailModal, TaskDetailData } from "../modals/TaskDetailModal";

// ponytail: Static mock data embedded directly in component. Ceiling: server API integration. Upgrade path: fetch from docApi.
const KPI_CARDS = [
  {
    id: "contract-value",
          ...
          <div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="flex items-center gap-1 text-xs px-2.5 py-1 border border-slate-200 rounded-md bg-white hover:bg-slate-50 text-slate-700">
                  <span>Bộ Lọc</span>
