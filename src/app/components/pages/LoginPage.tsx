...
export function LoginPage({ onLoginSuccess }: LoginPageProps) {
  ...
  return (
    <div className="h-screen w-screen bg-white p-4 sm:p-6 lg:p-8 overflow-hidden flex items-center justify-center font-sans antialiased">
      {/* 2 Column Split Grid matching exact Figma screenshot */}
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-3 text-[#8f8d95] hover:text-[#5d586c] transition-colors"
                    >
                ...
                <div className="flex items-center justify-between text-[13px] pt-1">
                  ...
                  <button
                    ...
                    className="text-[#ff4c51] font-normal text-[13px] hover:underline"
                  >
                    Quên mật khẩu?
                  </button>
                </div>
              ...
              <form onSubmit={handleForgotSubmit} className="space-y-4">
                ...
                <div className="text-center pt-2">
                  <button
                    ...
                    className="text-[#ff4c51] text-[13px] font-medium hover:underline inline-flex items-center gap-1"
                  >
      ...
      {/* 2FA Modal matching Figma node 25987:221436 */}
      {is2FAOpen && (
          ...
          <div className="w-full max-w-[420px] bg-white rounded-[12px] shadow-2xl border border-slate-100 p-6 space-y-5 animate-in zoom-in-95 duration-200 relative">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="p-1 rounded text-[#8f8d95] hover:text-[#2f2b3d] transition-colors"
              >
                <X className="size-5" />
              </button>
            </div>
            ...
            <button
              ...
              className="w-full h-[40px] rounded-[6px] bg-[#3f81ea] hover:bg-[#3471d4] text-white font-medium text-[14px] shadow-xs transition-colors"
            >
              Xác Nhận
            </button>
            ...
            <div className="text-center text-[13px] text-[#8f8d95] pt-1">
              ...
              <button
                ...
                className="text-[#3f81ea] font-medium hover:underline"
              >
                Email
              </button>{" "}
              hoặc{" "}
      ...
      {/* Change Password Modal matching Figma design */}
      {isChangePassOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs animate-in fade-in duration-200">
            ...
            <form onSubmit={handleChangePasswordSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setIsChangePassOpen(false)}
                  className="flex-1 py-2 px-4 rounded-[6px] border border-slate-300 bg-white text-slate-700 font-medium text-xs hover:bg-slate-50 transition-colors"
                >
                  Hủy
                </button>
                <button
                  type="submit"
                  className="flex-1 py-2 px-4 rounded-[6px] bg-[#3f81ea] hover:bg-[#3471d4] text-white font-medium text-xs shadow-sm transition-all"
                >
                  Xác Nhận
                </button>
              </div>
