...
import { IconCustomCheck } from "../icons";
...
// Custom Red Checkbox matching Figma Node 28474:49329
...
// Data Model matching Figma Node 28474:49330
...
export function ContractAcceptanceDetailPage({
  ...
  const [expandedRows, setExpandedRows] = useState<Record<string, boolean>>({
    "item-1": true, // expanded by default as in Figma
  });
  ...
  return (
    <div className="space-y-6 bg-[#f8f7fa] p-6">
      ...
      {/* Card 2: Chi tiết hạng mục (Figma Node 28474:49329 Horizontal Scroll Table) */}
      <WidgetCard className="space-y-4">
        <h3 className="text-[16px] font-bold text-[#2f2b3d]">
          Chi tiết hạng mục
        </h3>

        {/* Horizontal Scrollable Container with clean outer table border */}
            ...
            <table className="w-full border-collapse text-left text-[12px] bg-white">
              <thead>
                ...
                <tr className="border-b border-[#dbdade] text-[11px] font-semibold text-[#2f2b3d] bg-white">
                  {/* Under Theo HĐ, Đã NT, Còn lại */}
                  <th colSpan={2} className="border-r border-[#dbdade] p-0" />
                  <th colSpan={2} className="border-r border-[#dbdade] p-0" />
                  <th colSpan={2} className="border-r border-[#dbdade] p-0" />

                  {/* Months under Chi tiết nghiệm thu */}
                ...
                {/* Header Row 3 (Sub-headers: SL & Giá trị) */}
                <tr className="border-b border-[#dbdade] text-[11px] font-semibold text-[#2f2b3d] bg-white">
                  {/* Theo Hợp đồng */}
                  ...
                  return (
                    <div key={item.id} style={{ display: "contents" }}>
                      ...
                      <tr className="hover:bg-slate-50/70 border-b border-[#dbdade]">
                        {/* Hạng mục with chevron on the right (matching Figma) */}
                        ...
                        {/* PAKD tương ứng custom Red checkboxes (Figma 28474:49329) */}
                      ...
                      {/* Expandable Sub-table: Chi tiết phân bổ nghiệm thu (Figma Node 28474:49329 seamless frame) */}
                        ...
                        <tr className="border-b border-[#dbdade]">
                          <td colSpan={21} className="p-0">
                            <div className="bg-white">
                                ...
                                <tbody className="divide-y divide-[#dbdade] text-[12px]">
                                  {item.subBreakdown.map((sub, sIdx) => (
                                    <tr key={sIdx} className="hover:bg-slate-50/50 border-b border-[#dbdade]">
                                      ...
                                      {/* Tổng giá trị phân bổ nghiệm thu */}
                                  ...
                                  {/* Total Breakdown Row: Tổng phân bổ */}
                              ...
                              {/* Footer Action: Button Lưu (Figma Node 28538:48776) */}
