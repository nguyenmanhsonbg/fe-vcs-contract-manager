      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <button
            ...
            className="flex size-8 shrink-0 items-center justify-center rounded-[6px] text-slate-400 hover:bg-[#323444] hover:text-white transition-colors cursor-pointer"
      ...
      <div className="px-3 py-2 border-b border-[#35353d] flex items-center justify-center">
        {isMini ? (
          <button
            ...
            className="flex size-10 items-center justify-center rounded-[6px] border border-[#444656] bg-[#2b2c34] text-white hover:bg-[#343644] transition-colors cursor-pointer"
          ...
          <Button
            onClick={onUploadClick}
            className="w-full justify-center gap-2 border border-[#444656] bg-[#2b2c34] text-white hover:bg-[#343644] transition-colors rounded-[6px] font-medium text-xs h-10 shadow-xs whitespace-nowrap overflow-hidden cursor-pointer"
          >
            ...
            return (
              ...
              >
                <button
                  ...
                  className={`flex size-10 items-center justify-center rounded-[6px] transition-all cursor-pointer ${
                    activeState
                ...
                {/* Mini Mode Floating Detail Popover */}
                {hoveredIdx === idx && (
                  <div
                  ...
                  >
                    ...
                    {hasChildren ? (
                        ...
                        {item.children?.map((child) => {
                          ...
                          return (
                            <button
                              ...
                              className="group relative flex w-full items-center gap-3 pl-3 pr-2 py-1 text-xs text-left transition-colors cursor-pointer"
                            >
                              <span
                      ...
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 text-xs rounded-[6px] transition-colors cursor-pointer ${
                          activeState
            ...
            <div key={item.label} className="border-b border-[#35353d] py-2 last:border-b-0">
              {hasChildren ? (
                <Collapsible defaultOpen className="group/collapsible">
                  <CollapsibleTrigger
                    className={`group flex w-full items-center gap-3 rounded-[6px] px-3.5 py-2.5 text-sm transition-all focus-visible:outline-none cursor-pointer ${
                      activeState
                      ...
                      {item.children?.map((child) => {
                        ...
                        return (
                          <button
                            ...
                            className={`group relative flex w-full items-center gap-3 pl-3 pr-2 py-1.5 text-xs text-left rounded-[4px] transition-colors cursor-pointer ${
                              isChildActive
