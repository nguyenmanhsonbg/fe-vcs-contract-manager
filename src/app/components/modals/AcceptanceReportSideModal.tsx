    ...
    >
      ...
      >
        ...
        <div className="custom-scrollbar flex-1 overflow-y-auto p-6 space-y-4 bg-[#f8f7fa]">
          {/* Top Document Viewer Box (Matching Figma Node 28544:25367) */}
          ...
          {/* ========================================================================= */}
          {/* Accordion 1: Thông tin chung (Figma Node 28544:25367) */}
          {/* ========================================================================= */}
          ...
          {/* ========================================================================= */}
          {/* Accordion 2: Nội dung nghiệm thu (Figma Node 28538:25868) */}
          {/* ========================================================================= */}
          <div className="rounded-[8px] bg-white shadow-[0_2px_8px_rgba(47,43,61,0.08)] overflow-hidden">
            <button
        ...
        <div className="flex shrink-0 items-center justify-end border-t border-slate-200/80 px-6 py-4 bg-white">
          <button
            onClick={() => onOpenChange(false)}
            className="rounded-[6px] bg-[#2884ff] hover:bg-[#1a73e8] px-6 py-2 text-[13px] font-medium text-white shadow-2xs transition-colors"
          >
            Đóng
          </button>
        </div>
